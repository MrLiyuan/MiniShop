...
<%
	Buyer buyer = (Buyer) request.getAttribute("showuser");
%>
...
<div class="admin-biaogelist">
    ...
    <div class="fbneirong">
      <form class="am-form" action="UpdateUserServlet" method="post" >
      	<input type="text" name="b-id" value="${user.id }" style="display:none"/>
        <div class="am-form-group am-cf">
          <div class="zuo">姓名：</div>
          <div class="you">
            <input type="text" class="am-input-sm" name="b-name" placeholder="请输入标题" value="${user.name }" />
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">手机号：</div>
          <div class="you">
            <input type="text" class="am-input-sm" name="b-phone" placeholder="请输入标题" value="${user.phone }" />
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">邮箱：</div>
          <div class="you">
            <input type="text" class="am-input-sm" name="b-email" placeholder="请输入标题" value="${user.email }" />
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">密码：</div>
          <div class="you">
            <input type="password" class="am-input-sm" name="b-password" placeholder="请输入标题" value="${user.password }" />
          </div>
        </div>
