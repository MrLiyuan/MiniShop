! function(e, t) {
	...
	function U(e) {
		...
		if(null == t ? n = window.clipboardData && window.clipboardData.getData("text") : (n = t.getData("text/plain"), i = t.getData("text/html")), !i && n && (i = "<p>" + a(n) + "</p>"), i) {
			var o = i.split("</html>");
			return 2 === o.length && (i = o[0]), i = i.replace(/<(meta|script|link).+?>/gim, ""), i = i.replace(/\s?(class|style)=('|").+?('|")/gim, "")
		}
	}
	...
	function H(e, t) {
		...
		this.id = "wangEditor-" + O++, this.toolbarSelector = e, this.textSelector = t, this.customConfig = {}
	}
	i.prototype = {
		constructor: i,
		forEach: function(e) {
	...
	var J = {};
	J.bold = s, J.head = d, J.link = h, J.italic = p, J.redo = f, J.strikeThrough = g, J.underline = m, J.undo = w, J.list = v, J.justify = b, J.foreColor = E, J.backColor = y, J.quote = B, J.code = C, J.emoticon = x, J.table = I, J.video = Q, J.image = D, M.prototype = {
		constructor: M,
		init: function() {
			var e = this,
				t = this.editor;
		...
		_pasteHandle: function() {
			...
			t.on("paste", function(n) {
				if(!L.isIE()) {
					...
					if(A) {
						var r = A.getNodeName();
						if("CODE" !== r && "PRE" !== r && "TD" !== r && "TH" !== r)
							if("DIV" === r || "<p><br></p>" === t.html()) {
								if(!i) return;
								try {
	...
	T.prototype = {
		...
		insertLinkImg: function(e) {
			...
			if(e) {
				...
				i.onload = function() {
					i = null, n.cmd.do("insertHTML", '<img src="' + e + '" style="max-width:100%;"/>')
				}, i.onerror = function() {
					i = null, t._alert("插入图片错误", 'wangEditor: 插入图片出错，图片链接是 "' + e + '"，下载该链接失败')
				}, i.onabort = function() {
					i = null
				}, i.src = e
			}
		...
		uploadImg: function(e) {
			...
			if(e && e.length) {
				...
				if(r(w, function(e) {
					...
					}, p.before && "function" == typeof p.before && p.before(B, n, w), A(h, function(e, t) {
