...
<%
	Map<String, Object> map = (Map<String,Object>) request.getAttribute("showindent");
%>
...
<div class="admin-biaogelist">
    ...
    <div class="fbneirong">
      <form class="am-form" action="UpdateIndentServlet" method="post">
        <input type="text" name="i-id" value="${map.indent.id }" style="display:none">
        <div class="am-form-group am-cf">
          <div class="zuo">收货人：</div>
          <div class="you">
            <input type="text" class="am-input-sm" name="ib-name" placeholder="请输入标题" value="${map.bname }"/>
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">商品名称：</div>
          <div class="you">
            <input type="text" class="am-input-sm" name="ig-name" placeholder="请输入标题" value="${map.gname }" />
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">商品数量：</div>
          <div class="you">
            <input type="text" class="am-input-sm" name="i-num" placeholder="请输入标题" value="${map.indent.goodsNum }" />
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">总价格：</div>
          <div class="you">
            <input type="text" class="am-input-sm" name="i-price" placeholder="请输入标题" value="${map.indent.totalPrice }" />
          </div>
        </div>
        <div class="am-form-group am-cf">
          <div class="zuo">创建时间：</div>
          <div class="you">
            <input type="text" class="am-input-sm" name="i-time" placeholder="请输入标题" value="${map.indent.createTime }" />
          </div>
        </div>
		<script>
